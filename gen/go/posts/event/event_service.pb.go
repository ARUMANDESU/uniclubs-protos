...
var file_posts_event_event_service_proto_rawDesc = []byte{
	...
	0x43, 0x54, 0x10, 0x01, 0x32, 0xfb, 0x08, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x36,
	...
	0x65, 0x63, 0x74, 0x12, 0x3e, 0x0a, 0x0c, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x45, 0x76,
	...
	0x74, 0x1a, 0x12, 0x2e, 0x70, 0x6f, 0x73, 0x74, 0x73, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x4f,
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x3d, 0x0a, 0x0c, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65,
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x19, 0x2e, 0x70, 0x6f, 0x73, 0x74, 0x73, 0x2e, 0x48, 0x61,
	...
	0x65, 0x6e, 0x74, 0x12, 0x19, 0x2e, 0x70, 0x6f, 0x73, 0x74, 0x73, 0x2e, 0x48, 0x61, 0x6e, 0x64,
	0x6c, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12,
...
var file_posts_event_event_service_proto_depIdxs = []int32{
	...
	23, // 27: posts.Event.ApproveEvent:input_type -> posts.HandleEventRequest
	23, // 28: posts.Event.RejectEvent:input_type -> posts.HandleEventRequest
	16, // 29: posts.Event.AddCollaborator:input_type -> posts.AddCollaboratorRequest
	17, // 30: posts.Event.RemoveCollaborator:input_type -> posts.RemoveCollaboratorRequest
	22, // 31: posts.Event.HandleInviteClub:input_type -> posts.HandleInviteClubRequest
	20, // 32: posts.Event.RevokeInviteClub:input_type -> posts.RevokeInviteRequest
	18, // 33: posts.Event.AddOrganizer:input_type -> posts.AddOrganizerRequest
	19, // 34: posts.Event.RemoveOrganizer:input_type -> posts.RemoveOrganizerRequest
	21, // 35: posts.Event.HandleInviteUser:input_type -> posts.HandleInviteUserRequest
	20, // 36: posts.Event.RevokeInviteUser:input_type -> posts.RevokeInviteRequest
	1,  // 37: posts.Event.GetEvent:output_type -> posts.EventObject
	14, // 38: posts.Event.ListEvents:output_type -> posts.ListEventsResponse
	1,  // 39: posts.Event.CreateEvent:output_type -> posts.EventObject
	1,  // 40: posts.Event.UpdateEvent:output_type -> posts.EventObject
	1,  // 41: posts.Event.DeleteEvent:output_type -> posts.EventObject
	1,  // 42: posts.Event.PublishEvent:output_type -> posts.EventObject
	1,  // 43: posts.Event.UnpublishEvent:output_type -> posts.EventObject
	1,  // 44: posts.Event.ApproveEvent:output_type -> posts.EventObject
	1,  // 45: posts.Event.RejectEvent:output_type -> posts.EventObject
	25, // 46: posts.Event.AddCollaborator:output_type -> google.protobuf.Empty
	1,  // 47: posts.Event.RemoveCollaborator:output_type -> posts.EventObject
	1,  // 48: posts.Event.HandleInviteClub:output_type -> posts.EventObject
	25, // 49: posts.Event.RevokeInviteClub:output_type -> google.protobuf.Empty
	25, // 50: posts.Event.AddOrganizer:output_type -> google.protobuf.Empty
	1,  // 51: posts.Event.RemoveOrganizer:output_type -> posts.EventObject
	1,  // 52: posts.Event.HandleInviteUser:output_type -> posts.EventObject
	25, // 53: posts.Event.RevokeInviteUser:output_type -> google.protobuf.Empty
